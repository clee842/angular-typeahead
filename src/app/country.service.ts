...
export class CountryService {
  ...
  private coutries: string[] = [
    ...
    'Canada', 'Cape Verde', 'Cayman Islands', 'Chad', 'Chile', 'China', 'Colombia', 'Congo', 'Cook Islands',
    ...
    'Turkmenistan', 'Turks Caicos', 'Uganda', 'Ukraine', 'United Arab Emirates', 'United Kingdom', 'United States',
    'Uruguay', 'Uzbekistan', 'Venezuela', 'Vietnam', 'Virgin Islands (US)', 'Yemen', 'Zambia', 'Zimbabwe'];

  public getCountries(query: string): Observable<string[]> {
    console.log(query);
    return of(this.coutries.filter(c => c.indexOf(query) > -1));
  }
}
